...
#This is the brain of the nematode
...
def fireNeuron(fneuron):
  ...
  if fneuron != "MVULVA":
    #Get the function named that neuron and run it
    f = eval(fneuron)
    f()
...
def spawn():
  ...
  tfood = 0
  while True:
    #Okay, so is this what hapens when we're about to hit something?
    #Can we make this trigger in accordance with the actual environment...
    if dist>0 and dist<30:
      ...
      #Appears to be the only time this increases
      #Appears to be some cyclical food thing, not sure what its about.
      tfood += 0.5
...
#So how do we figure out where food is
